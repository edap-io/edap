...
public class ProtoBuf {
    ...
    public static Object der(byte[] data) throws io.edap.protobuf.ProtoException {
    ...
    public static Object der(byte[] data, int offset, int len) throws io.edap.protobuf.ProtoException {
     ...
     * @param cls 给定的java对象的class
     * @return 返回java对象
     * @throws io.edap.protobuf.ProtoException
     */
