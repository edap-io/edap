...
public class ListFixed64BuilderTest extends AbstractTest {

    @Test
    public void testListFixed64Test() {
        String workPath = getWorkPath();
        String[] args = new String[]{
                "-proto", workPath + "/resources/proto/list_fixed64.proto",
                "-src", workPath + "/tmpsrc/"
        ...
        String[] lines = ("package io.edap.protobuf.test.message.v3;\n" +
                ...
                "\n" +
                "public class ListFixed64 implements Serializable {\n" +
                "\n" +
                ...
                "    }\n" +
                "\n" +
                "    public ListFixed64 setValue(List<Long> value) {\n" +
                "        this.value = value;\n" +
                "        return this;\n" +
                "    }\n" +
                "\n" +
        ...
        String path = workPath + "/tmpsrc/" + packName + "/ListFixed64.java";
