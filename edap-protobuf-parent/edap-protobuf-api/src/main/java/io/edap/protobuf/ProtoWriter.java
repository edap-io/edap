...
public interface ProtoWriter extends BufWriter {
    BufOut getBufOut();
    ...
    void writeFloat(byte[] fieldData, float value);
    void writePackedInts(byte[] fieldData, int[] values, Field.Type type);
    void writePackedInts(byte[] fieldData, Integer[] values, Field.Type type);
    void writePackedInts(byte[] fieldData, List<Integer> value, Field.Type type);
    void writePackedInts(byte[] fieldData, Iterable<Integer> value, Field.Type type);
    ...
    void writeDouble(byte[] fieldData, double value);
    void writePackedLongs(byte[] fieldData, Long[] values, Field.Type type);
    void writePackedLongs(byte[] fieldData, long[] values, Field.Type type);
    void writePackedLongs(byte[] fieldData, List<Long> values, Field.Type type);
    void writePackedLongs(byte[] fieldData, Iterable<Long> values, Field.Type type);
    ...
    <T> void writeMessage(T msg, ProtoEncoder<T> encoder) throws EncodeException;
    <T> void writeMessage(byte[] fieldData, int tag, T msg, ProtoEncoder<T> encoder) throws EncodeException;
    <T> void writeMessages(byte[] fieldData, int tag, T[] msg, ProtoEncoder<T> encoder) throws EncodeException;
    <T> void writeMessages(byte[] fieldData, int tag, List<T> msg, ProtoEncoder<T> encoder) throws EncodeException;
    <T> void writeMessages(byte[] fieldData, int tag, Iterable<T> msg, ProtoEncoder<T> encoder) throws EncodeException;
