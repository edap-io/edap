...
import io.edap.mqtt.*;
import io.edap.mqtt.decoder.PubCompDecoder;
...
public class PubCompDecoderTest {

    @Test
    public void testParse() {
        PubCompDecoder decoder = new PubCompDecoder();
        ParseResult<ControlPacket> r;
        FastBuf buf = new FastBuf(4096);
        int fixHeader = (ControlPacketType.PUBCOMP_VALUE << 4);
        ...
        assertEquals(r.getMessage() instanceof PubComp, true);
        PubComp pubComp = (PubComp)r.getMessage();
