...
import io.edap.mqtt.*;
import io.edap.mqtt.decoder.PubRecDecoder;
...
public class PubRecDecoderTest {

    @Test
    public void testParse() {
        PubRecDecoder decoder = new PubRecDecoder();
        ParseResult<ControlPacket> r;
        FastBuf buf = new FastBuf(4096);
        int fixHeader = (ControlPacketType.PUBREC_VALUE << 4);
        ...
        assertEquals(r.getMessage() instanceof PubRec, true);
        PubRec pubComp = (PubRec)r.getMessage();
