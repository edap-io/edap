...
import io.edap.mqtt.decoder.PingRespDecoder;
...
public class PingRespDecoderTest {

    @Test
    public void testParse() {
        PingRespDecoder decoder = new PingRespDecoder();
        ParseResult<ControlPacket> r;
        FastBuf buf = new FastBuf(4096);
        int fixHeader = (ControlPacketType.PINGRESP.getValue() << 4);
