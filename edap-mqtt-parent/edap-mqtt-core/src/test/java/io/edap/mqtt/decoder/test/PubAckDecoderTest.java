...
import io.edap.mqtt.*;
import io.edap.mqtt.decoder.PubAckDecoder;
...
public class PubAckDecoderTest {
    ...
    public void testParse() {
        PubAckDecoder decoder = new PubAckDecoder();
        ParseResult<ControlPacket> r;
        FastBuf buf = new FastBuf(4096);
        int fixHeader = (ControlPacketType.PUBACK_VALUE << 4);
        ...
        assertEquals(r.getMessage() instanceof PubAck, true);
        PubAck pubAck = (PubAck)r.getMessage();
