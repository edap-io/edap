...
public class ListUint64BuilderTest extends AbstractTest {

    @Test
    public void testListUint64Test() {
        String workPath = getWorkPath();
        String[] args = new String[]{
                "-proto", workPath + "/resources/proto/list_uint64.proto",
                "-src", workPath + "/tmpsrc/"
        ...
        String[] lines = ("package io.edap.protobuf.test.message.v3;\n" +
                ...
                " */\n" +
                "public class ListUint64 implements Serializable {\n" +
                "\n" +
                ...
                "    }\n" +
                "\n" +
                "    public ListUint64 setValue(List<Long> value) {\n" +
                "        this.value = value;\n" +
                "        return this;\n" +
                "    }\n" +
                "\n" +
        ...
        String path = workPath + "/tmpsrc/" + packName + "/ListUint64.java";
