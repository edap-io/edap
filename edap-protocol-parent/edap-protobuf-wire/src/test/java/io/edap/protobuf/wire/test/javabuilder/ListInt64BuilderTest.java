...
public class ListInt64BuilderTest extends AbstractTest {

    @Test
    public void testListInt64Test() {
        String workPath = getWorkPath();
        String[] args = new String[]{
                "-proto", workPath + "/resources/proto/list_int64.proto",
                "-src", workPath + "/tmpsrc/"
        ...
        String[] lines = ("package io.edap.protobuf.test.message.v3;\n" +
                ...
                "\n" +
                "public class ListInt64 implements Serializable {\n" +
                "\n" +
                ...
                "    }\n" +
                "\n" +
                "    public ListInt64 setValue(List<Long> value) {\n" +
                "        this.value = value;\n" +
                "        return this;\n" +
                "    }\n" +
                "\n" +
        ...
        String path = workPath + "/tmpsrc/" + packName + "/ListInt64.java";
