...
public class OneMapBuilderTest extends AbstractTest {

    @Test
    public void testOneMapTest() {
        String workPath = getWorkPath();
        String[] args = new String[]{
                "-proto", workPath + "/resources/proto/one_map.proto",
                "-src", workPath + "/tmpsrc/"
        ...
        String[] lines = ("package io.edap.protobuf.test.message.v3;\n" +
                ...
                "\n" +
                "public class OneMap implements Serializable {\n" +
                "\n" +
                ...
                "    }\n" +
                "\n" +
                "    public OneMap setValue(Map<String, Project> value) {\n" +
                "        this.value = value;\n" +
                "        return this;\n" +
                "    }\n" +
                "\n" +
        ...
        String path = workPath + "/tmpsrc/" + packName + "/OneMap.java";
