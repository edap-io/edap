...
public class Reserved {
    ...
    public static Reserved parseReserved(String expression, List<Comment> comments) throws ProtoParseException {
        String exp = expression.trim();
        if (exp.isEmpty()) {
            throw new ProtoParseException("reserved expression is empty");
        }
        Reserved reserved;
    ...
    public static TagReserved readRagReserved(String expression) throws ProtoParseException {
    ...
    public static List<String> readFieldNames(String exp) throws ProtoParseException {
        ...
        throw new ProtoParseException("reserved not end \";\"");
    }
    ...
    private static ParseFieldNameResult readFieldName(String exp, int pos)
        ...
        if (startChar != '\'' && startChar != '"') {
            throw new ProtoParseException("field name not start with ' or \"");
        }
