...
public interface ProtoBufDecoder<T> {
     ...
     * @throws ProtoException 如果给定的数据不是正确的ProtoBuf编码的数据则抛错
     */
    T decode(ProtoBufReader reader) throws ProtoException;

    default T decode(ProtoBufReader reader, int endGroupTag) throws ProtoException {
