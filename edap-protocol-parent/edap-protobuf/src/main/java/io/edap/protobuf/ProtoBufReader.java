...
public interface ProtoBufReader {
     ...
     * @throws ProtoException
     */
    <T extends Object> T readMessage(ProtoBufDecoder<T> decoder) throws ProtoException;
     ...
     * @throws ProtoException
     */
    default <T extends Object> T readMessage(ProtoBufDecoder<T> decoder, int endTag) throws ProtoException {
