...
public class TestByteArrayBuilder {
    ...
    public void testAppendString(String str) {
        if ("null".equals(str)) {
            str = null;
        }
        ByteArrayBuilder builder = new ByteArrayBuilder();
        ...
        builder.append(str);
        if (str != null) {
            assertArrayEquals(builder.toByteArray(), str.getBytes(StandardCharsets.UTF_8));
        } else {
            assertArrayEquals(builder.toByteArray(), "null".getBytes());
        }
    }
    ...
    public void testAppendSubString() {
        ...
        assertArrayEquals(builder.toByteArray(), str.substring(1).getBytes(StandardCharsets.UTF_8));
    ...
    public void testHugeCapacity() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        Method method = ByteArrayBuilder.class.getDeclaredMethod("hugeCapacity", int.class);
    ...
    public void testAppendBoolean() {
        ...
        builder.reset();
        builder.append(Boolean.valueOf(true));
        assertArrayEquals(builder.toByteArray(), new byte[]{'t','r','u','e'});
