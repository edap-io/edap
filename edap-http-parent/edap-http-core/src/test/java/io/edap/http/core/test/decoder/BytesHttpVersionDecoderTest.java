...
public class BytesHttpVersionDecoderTest {

	@Test
	public void testDecode() {
		BytesHttpVersionDecoder decoder = new BytesHttpVersionDecoder();
		...
		sb.setLength(0);
		HttpVersion version = decoder.decode(buf, sb, request);
		assertNull(version);

		buf.reset();
		buf.write("http/0.9\r\n".getBytes(StandardCharsets.UTF_8));
		version = decoder.decode(buf, sb, request);
