 ...
 * HTTP协议解析器
 */
public class RangeHttpDecoder extends AbstractHttpDecoder implements Decoder<HttpRequest, HttpNioSession> {
    ...
    static HeaderDataDecoder HEAADER_DACODER     = new HeaderDataDecoder();
