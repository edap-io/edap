...
public class MethodCache {
    ...
    private Map<FastBufDataRange, MethodInfo> rangeCache;
    ...
    public MethodInfo getMethodInfo(FastBufDataRange dataRange) {
        ...
        if (m == null) {
            synchronized (this) {
                ...
                m.setMethod(method);
                m.setMethodIndex(index);
                rangeCache.put(FastBufDataRange.from(method), m);
            }
        }
        return m;
    }
    ...
    public static final MethodCache instance() {
